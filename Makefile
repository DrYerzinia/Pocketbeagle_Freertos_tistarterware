...
###############################################################################
#
#  Change hard code paths to use LIB_PATH environmental define. This makes
#  the TOOLs location the same as TI starterware
#  V 1.1
#  Graham Stott
##############################################################################
...
app : obj/app.out
	...
	./ti_image $(APP_LOAD_ADDR) NONE obj/app.bin bin_files/app
	@rm ti_image
